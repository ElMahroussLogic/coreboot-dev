...
;; DATA
__firmware_splash: db ">> CoreBoot for x86, Copyright 2024, Mahrouss Logic, press F to boot into SysDiag...", 0xd, 0xa
				db ">> Booting...", 0xd, 0xa, 0x0

__firmware_no_xpt: db ">> Not an XPT drive error.", 0xd, 0xa, 0x0

__firmware_unimpl:  db ">> Unimplemented routine error.", 0xd, 0xa, 0x0

__overflow:  db ">> Stack overflow error.", 0xd, 0xa, 0x0

__invalid_opcode:  db ">> Illegal instruction error.", 0xd, 0xa, 0x0

__division_by_zero:  db ">> Division by zero error.", 0xd, 0xa, 0x0

__press_any_key: db ">> Press any key to continue...", 0xd, 0xa, 0x0

__vector_print_screen:
    push    si
...
jmp 0xF000:0x0100 ; fff0: We start here after CPU reset

__bios_date: db "01/27/24", 0 ; fff5: BIOS release date
